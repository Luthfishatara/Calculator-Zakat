  ...
  render() {
    ...
    return(
        ...
        <ScrollView>
            ...
            />
        <TouchableOpacity style={{ alignSelf: 'flex-end' }} onPress={() => this.props.navigation.navigate('Counter')}>
                <Image source={require('../../assets/next.png')} style={{height: 60, width: 60, alignSelf: 'center', margin: 5, borderRadius: 30}}/>
        </TouchableOpacity>
